...
### Day 14 (June 11, Thu)
The fourteenth day was dedicated to **IC layout design**. We were introduced to the fundamentals of layout, including design rules, device placement, and interconnect routing. The lecture emphasized how layout directly impacts performance, parasitics, and manufacturability. We studied concepts like design rule checking (DRC), layout versus schematic (LVS), and the importance of symmetry in analog layouts. Practical demonstrations showed how transistor matching and careful routing reduce mismatches and improve circuit reliability. In the lab, we explored layout tools, practicing the placement of MOS devices and interconnects while adhering to design rules. By the end of the day, we understood how layout is not just a physical representation of a schematic but a critical step that determines the success of IC fabrication.
